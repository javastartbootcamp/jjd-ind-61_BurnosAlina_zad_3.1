...
public class Main {
    public static void main(String[] args) {
        ChristmasTreeDescription tree1 = new ChristmasTreeDescription("Zielony", 1.8, 158);
        ChristmasTreeDescription tree2 = new ChristmasTreeDescription("Zielono-bialy", 2.00,190);
